...
const Row: React.FC<RowProps> = (props) => {
    ...
    return(
            ...
            <div className=" mt-3 ">
                <a href={titleLink} className="text-white text-2xl" target="_blank" rel="noreferrer">
                    {/* <HoverCard>
                        ...
                        <HoverCardContent className="text-black bg-emerald-400 h-4 text-md mt-[-34px]">
        ...
        //         </a>
        //     </div>
        //     <div className="flex bg-pink-600 gap-4 float-right">
        //         <Button variant={"myButton"}  className="text-xl" onClick={openClick}>
        //         <MdOpenInNew />
        //         </Button>
        //         {/* <p className="bg-red-200">{id}</p> */}
        //         <Button variant="secondary" className="text-xl" onClick={deleteThisNote} ><MdDelete /></Button>
        //         {drawerOpen && <WrapperDrawer id={id}/>}
        //     </div>
        // </div>
        // </UtilsProvider>
